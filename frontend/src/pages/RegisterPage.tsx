...
export function RegisterPage() {
  const { register, user, isInitializing, isAuthenticating } = useAuth()
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      await register({ email: em, username: u, password: p })
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs leading-relaxed text-slate-500">
              At least 8 characters. Django password rules apply.
            </p>
          </div>
